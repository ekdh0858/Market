...
public class Chap6Ex9 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 컨텍스트에 꼭 init 메서드로만 접근할 수 있는 건 아니고
		// HttpServlet부모 클래스 가 제공하는 getServletContext 메서드를 사용하면
		// doGet메서드 안에서 컨텍스트에 직접 접근할 수 있음
		
		//같은 애플리케이션 내 모든 서블릿이 같은 컨텍스트에 접근할 수 잇으므로
		...
		out.print("shutDownTime = " +shutDownTime+"\n");
