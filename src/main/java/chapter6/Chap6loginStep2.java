...
public class Chap6loginStep2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//일반적으로 회원정보 조회 동작은 Database와연동을 해서
		//DB에서 userId와일치하는 회원정보를 가져오는 코드를 넣게 됨
		//우리는 아직 DB를 배우지 않앗으니까 주석으로 대체
		//회원정보를 
		//이렇게
		//저렇게
		//조회했다
		
		//회원정보 조회 성공 여부 / true ->아이디와 일치하는 회원 정보 있음 / false ->일치하는 회원 정보 없음
		boolean exist = true;
		if(!exist) {
			// 회원 정보가 조회되지 않앗다면
			// BAD_REQUEST 응답
